...
model = dict(
    ...
    backbone=dict(
        type='segformer',
        pretrain_path='/home/hexingyang/DDP/segmentation/ckpts/trufor.pth.tar',
    ),
    neck=[
        dict(
            type='FPN',
...
evaluation = dict(interval=1, metric='mIoU', by_epoch=True, pre_eval=True)
