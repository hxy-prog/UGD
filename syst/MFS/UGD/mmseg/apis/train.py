...
from mmseg.core.hook import IterShuffleHook,EpochShuffleHook
...
def train_segmentor(model,
    ...
    # shufhook = EpochShuffleHook(dataset[0])
    # runner.register_hook(shufhook,priority='HIGHEST')
...
# 打印第一个批次的内容
    # rank, world_size = get_dist_info()
    # if rank==0:
    #     print(first_batch['img'].data[0].shape)
    #     print(first_batch['gt_semantic_seg'].data[0].shape)
    # exit(0)
