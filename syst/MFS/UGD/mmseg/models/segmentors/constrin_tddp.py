...
class CTDDP(CtEncoderDecoder):
    ...
    def __init__(self,
                 ...
                 accumulation=False,
                 **kwargs):
        super(CTDDP, self).__init__(**kwargs)
    ...
    def encode_decode(self, img,img_metas,realimg):
        ...
        xreal= self.textract_feat(realimg)[0]
    ...
    def ddim_sample(self, x, xreal,img_metas):
        ...
        for idx, (times_now, times_next) in enumerate(time_pairs):
            ...
            # import cv2
            # cv2.imwrite('ddimvis/'+str(idx)+'r.jpg',mask_pred[0].cpu().numpy()*125)
