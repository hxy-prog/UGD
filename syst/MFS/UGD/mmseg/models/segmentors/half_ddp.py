...
class half_DDP(EncoderDecoder):
    ...
    def __init__(self,
                 ...
                 accumulation=False,
                 **kwargs):
        super(half_DDP, self).__init__(**kwargs)
        ...
        self.embedding_table = nn.Embedding(self.num_classes + 1, 128)
        ...
        self.transform = ConvModule(
            self.decode_head.in_channels[0]+128,
    ...
    def ddim_sample(self, x, img_metas):
        ...
        mask_t = torch.randn((self.randsteps, 128, h, w), device=device)
        outs = list()
