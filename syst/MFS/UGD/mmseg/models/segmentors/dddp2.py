...
class DDDP2(EncoderDecoder):
    ...
    def __init__(self,
                 ...
                 accumulation=False,
                 **kwargs):
        super(DDDP2, self).__init__(**kwargs)
    ...
    def encode_decode(self, img, img_metas):
        ...
        img=torch.cat([img,noiseprint],dim=1)
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg):
        ...
        # cv2.imwrite('dpd'+tim+'.jpg',cv2.cvtColor(denormalized_img[0].permute(1,2,0).cpu().numpy(), cv2.COLOR_RGB2BGR)*255)
        # exit(0)
